...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium portfolio of Chris Ogbonnaya — UI/UX Designer, Web Designer, Graphic Designer & Full-Stack Developer based in Lagos, Nigeria." },
      { name: "author", content: "Chris Ogbonnaya" },
